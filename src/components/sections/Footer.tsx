      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="md:col-span-5 lg:col-span-4">
            ...
            <div className="text-gray-400 mb-6 leading-relaxed min-h-[3.5rem] flex items-center">
              <TypewriterText 
                texts={[
                  "Crafting scalable full-stack web applications and robust API architectures.",
                  "Building high-performance React.js, Node.js, and AI-driven solutions.",
                  "Turning complex ideas into intuitive, modern, and high-impact digital products."
                ]}
                typingSpeed={50}
                deletingSpeed={25}
                pauseTime={3000}
